...
class DataBaseHelper : SQLiteOpenHelper {
    companion object {
        ...
        private const val DATABASE_VERSION = 4
         ...
         const val COLUMN_PRODUCTION_DATE_Y = "production_date_Y"
         const val COLUMN_PRODUCTION_DATE_M = "production_date_M"
         const val COLUMN_PRODUCTION_DATE_D = "production_date_D"
    ...
    override fun onCreate(database: SQLiteDatabase) {
        ...
        val sql = (("CREATE TABLE  "
                ...
                + COLUMN_PRODUCTION_DATE_Y + " TEXT,"
                + COLUMN_PRODUCTION_DATE_M + " TEXT,"
                + COLUMN_PRODUCTION_DATE_D + " TEXT,"
